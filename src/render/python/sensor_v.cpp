...
MI_PY_EXPORT(Sensor) {
    ...
    MI_PY_TRAMPOLINE_CLASS(PySensor, Sensor, Endpoint)
        ...
        .def_method(Sensor, adaptive_sampling)
        .def_method(Sensor, shutter_open)
        .def_method(Sensor, shutter_open_time)
        .def_method(Sensor, sample_diff_prob)
        .def_method(Sensor, needs_aperture_sample)
        .def_method(Sensor, pixel_weights)
        .def_method(Sensor, set_pixel_weights, "weights"_a)
        .def_method(Sensor, set_sample_diff_prob, "sample_diff_prob"_a)
